...
setwd("~/Desktop/marijuana_enrollment/programs/google_trend_figures")
...
df <- read_csv("~/Desktop/marijuana_enrollment/data/source_data/others/trends_raw.csv")
...
write_csv(df2,"~/Desktop/marijuana_enrollment/data/source_data/others/google_trend_df.csv")
